...
class ScamSamaLauncher:
    ...
    def setup_configuration(self):
        ...
        if self.verbose and current_token != 'TOKEN_HERE_DONT_PUT_QUOTES':
        ...
        config['YOUR_NUMBER_TO_CALL'] = Prompt.ask("Target Phone Number (with +)", default=config.get('YOUR_NUMBER_TO_CALL', ''))
    ...
    def show_status(self):
        ...
        settings = [
            ...
            ("Target Phone Number", "YOUR_NUMBER_TO_CALL"),
